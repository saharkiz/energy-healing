...
<html lang="en">
  <head>
    <title>شفاء الطاقة | طب الأعشاب والتقليدية دبي</title>
    <meta charset="utf-8">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate mt-5" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="d-flex align-items-center" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
    						...
    						<span class="watch">شاهد الفيديو</span>
    					</a>
						</p>
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">الطاقة العلاج لتسريع الشفاء</h1>
            <p class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">بسيط. تقنيات فعالة لتجربة الفرح!</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row services-section">
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">شفاء وجها لوجه</h3>
                <p>جلسة وجهاً لوجه ، يوصى به مرة واحدة في الأسبوع لإتاحة الوقت لظهور التردد بشكل كامل</p>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">شفاء المسافة</h3>
                <p>في حالة تعذر إجراء جلسة وجهاً لوجه ، فإننا نقدم جلسة شفاء عن بعد يشعر كثير من الناس أنها قد تكون أقوى بكثير.</p>
                <p><a href="#" class="btn btn-primary">اقراء المزيد على</a></p>
              </div>
            </div>
          </div>
